...
*   **Mecanismo:** Las agencias que ya utilizan Alvéo pueden habilitar un banner promocional ubicado al tope de su catálogo público. Los visitantes que hacen clic en este banner son dirigidos al formulario de registro público.
*   **Beneficios Comerciales:** Este es un proceso autogestionado. Durante el registro, el sistema solicita al usuario que indique manualmente a través de qué medio conoció la plataforma, lo cual permite generar reportes estadísticos precisos sobre el rendimiento de campañas de marketing. Si una agencia prefiere no mostrar la marca de Alvéo en su web, puede desactivar el banner desde su panel de configuración.
